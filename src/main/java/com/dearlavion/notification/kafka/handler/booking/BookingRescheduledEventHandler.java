...
public class BookingRescheduledEventHandler implements EventHandler<BookingEvent> {

    private final BookingEmailService bookingEmailService;

    @Override
    public KafkaEventType getEventType() {
        return KafkaEventType.BOOKING_RESCHEDULED;
    }
    ...
    public void handle(BookingEvent event) {
        bookingEmailService.sendBookingRescheduled(event);
    }
}
