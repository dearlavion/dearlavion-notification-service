...
public class BookingConfirmedEventHandler implements EventHandler<BookingEvent> {

    private final BookingEmailService bookingEmailService;

    @Override
    public KafkaEventType getEventType() {
        return KafkaEventType.BOOKING_CONFIRMED;
    }
    ...
    public void handle(BookingEvent event) {
        bookingEmailService.sendBookingConfirmedToCustomer(event);
    }
}
